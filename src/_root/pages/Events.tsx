      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-4">
            <button onClick={() => setShowMyEvents(false)} className={`px-4 py-2 rounded-md ${!showMyEvents ? "bg-blue-600" : "bg-gray-700"}`}>
              All Events
            </button>
            <button onClick={() => setShowMyEvents(true)} className={`px-4 py-2 rounded-md ${showMyEvents ? "bg-blue-600" : "bg-gray-700"}`}>
              My Events
            </button>
          </div>
        ...
        <div className="mb-8 space-y-4">
          ...
          <select
            ...
            className="w-full sm:w-64 p-3 bg-gray-800 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 transition-all"
          >
